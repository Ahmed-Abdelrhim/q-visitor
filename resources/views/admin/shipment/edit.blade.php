        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        <form action="{{ route('admin.shipment.update', encrypt($shipment->id)) }}" method="POST" >
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                    ...
                                    <div class="row" style="margin: 0 20px;">
                                        <div class="yey" style="margin: 0 20px !important;">
                                            <input type="checkbox" name="yes" style="width: 20px !important;" id="yes"
                                                   @if($shipment->quality_check == 1 ) checked @endif
                                        ...
                                        <div class="no" style="margin: 0 20px !important;">
                                            <input type="checkbox" name="no" style="width: 20px !important;" id="no" @if($shipment->quality_check == 0 ) checked @endif
